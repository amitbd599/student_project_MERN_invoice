          ...
          <div className="grid grid-cols-12 gap-[40px] border-b border-gray-800 pb-[40px]">
              ...
              <div className="flex gap-[30px]">
                <div>
                  <div className="bg-[#55E6A5] w-[80px] h-[80px] flex justify-center items-center rounded-full">
                    <img src="assets/img/map.svg" alt="" className="w-[40px]" />
                  </div>
                </div>
                <div>
                  <div>
            ...
            <div className="col-span-4">
              <div className="flex gap-[30px]">
                ...
                <div>
                  <div>
                    <h3 className="font-semibold text-[18px]">Lets talk us</h3>
            ...
            <div className="col-span-4">
              <div className="flex gap-[30px]">
                ...
                <div>
                  <div>
                    <h3 className="font-semibold text-[18px]">Send us email</h3>
